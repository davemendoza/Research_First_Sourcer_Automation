...
echo "=============================================================="
echo "🧠 AI Talent Intelligence Engine PRO – Best-in-Class Setup"
echo "=============================================================="
...
# ------------------ ENRICHMENT ENGINE -------------------------
cat <<'PY' > ai_talent_enrichment_pro.py
#!/usr/bin/env python3
...
chmod +x ai_talent_enrichment_pro.py

echo "=============================================================="
echo "✅ Setup Complete!  Run with your tokens:"
echo ""
echo "   export GITHUB_TOKEN='ghp_xxxxx'"
echo "   export HF_TOKEN='hf_xxxxx'"
echo "   export SEMANTIC_TOKEN='sem_xxxxx'"
echo "   python3 ai_talent_enrichment_pro.py"
echo ""
echo "=============================================================="
