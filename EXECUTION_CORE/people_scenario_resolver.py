...
SCENARIO_MAP: Dict[str, Dict[str, str]] = {'Frontier AI Research Scientist': {'SCENARIO_PREFIX': 'Frontier_AI_Research_Scientist', 'SCENARIO_SEED': 'frontier_ai_seed', 'ROLE_CANONICAL': 'Frontier AI Research Scientist'}}
