...
Changelog
- v3.2.0: Insert row_role_materialization pass to bind AI_Role_Type per row (fix semantically empty runs)
- v3.1.0: Timestamp contract + no guessing
- v3.0.x: Prior stabilization and EOF sanitation

Validation
python3 -m EXECUTION_CORE.run_safe <scenario_key>

Git Commands
git add EXECUTION_CORE/run_safe.py
git commit -m "Wire row_role_materialization pass into deterministic pipeline"
git push
"""
...
def main(argv: list[str]) -> None:
    ...
    # Phase 1 fix: bind AI_Role_Type deterministically per row
