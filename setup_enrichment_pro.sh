...
echo "=============================================================="
echo "🔧 Setting up AI Talent Engine PRO Enrichment Environment"
echo "=============================================================="
...
scrape_settings:
  ...
  delay_seconds: 2
  timeout_seconds: 10
  user_agent: "AITalentBot/1.0 (+https://research.ai-lab)"
...
logging:
  level: "INFO"
  save_enriched_copy: true
  audit_csv: "output/audit_enrichment_summary.csv"
YAML

echo "✅ Config.yaml written."

# --- Create autogen_enrichment_fetcher_pro.py ----------------------------------
cat <<'PY' > autogen_enrichment_fetcher_pro.py
#!/usr/bin/env python3
...
chmod +x autogen_enrichment_fetcher_pro.py

echo "=============================================================="
echo "✅ Setup Complete!"
echo "Run the enrichment engine using:"
echo ""
echo "   export GITHUB_TOKEN='ghp_your_token_here'"
echo "   export HF_TOKEN='hf_your_token_here'"
echo "   python3 autogen_enrichment_fetcher_pro.py"
echo ""
echo "=============================================================="
