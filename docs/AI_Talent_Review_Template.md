...
Part of the **AI Talent Engine – Research Tools Menu**, a research-grade portfolio of 32 verified modules mapping authentic AI-engineering contributions.  
**Schema Reference:** AI_Talent_Schema_Rules.md  
**Schema Version:** 3.5.0  
**Phase Scope:** Phase 8 / Phase 9  
...
**Schema Reference:** AI_Talent_Schema_Rules v3.5.0  
...
List verified technical clusters: LLM, VectorDB, RAG, Inference, CUDA, RLHF, Multimodal, Safety, etc. Include relevant frameworks or stacks.
...
## 🧭 HIRING MANAGER SUBMITTAL DECISION (Required)

**Evidence Basis:** Summarize decisive verified artifacts (repos, models, papers, patents, CV).  
**Evaluation Synthesis:** Integrate technical maturity, collaboration signals, and career trajectory.  
**Risks / Gaps:** List missing or weak verification areas.  
...
**Schema Reference:** AI_Talent_Schema_Rules v3.5.0  
**Compliance Agents:** #21 (Schema Validator) · #22 (Audit & Provenance) · #23 (Analytics Integrator) · #24 (Governance Compliance)  
...
*(Displayed exactly when user types “tools”)*  
──────────────────────────────  
Created by L. David Mendoza © 2025  
AI Talent Engine — Research-First Sourcer Automation System  
──────────────────────────────  
